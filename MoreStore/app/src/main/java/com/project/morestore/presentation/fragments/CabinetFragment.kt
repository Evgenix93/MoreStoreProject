...
class CabinetFragment: BottomNavigationFragment(R.layout.fragment_cabinet), CabinetMvpView {
    ...
    @Inject lateinit var cabinetPresenter: CabinetPresenter
    ...
    private fun setClickListeners(){
        binding.activeProductsTextView.setOnClickListener {
            findNavController().navigate(CabinetFragmentDirections.actionCabinetFragmentToMyProductsFragment(0))
        }
        binding.onModerationTextView.setOnClickListener {
            findNavController().navigate(CabinetFragmentDirections.actionCabinetFragmentToMyProductsFragment(1))
        }
        binding.archiveProductsTextView.setOnClickListener {
            findNavController().navigate(CabinetFragmentDirections.actionCabinetFragmentToMyProductsFragment(2))
        }
    ...
    override fun currentUserLoaded(user: User) {
        ...
        binding.profileBtn.setOnClickListener {
            findNavController().navigate(CabinetFragmentDirections.actionCabinetFragmentToProfileFragment2(user))
        }
