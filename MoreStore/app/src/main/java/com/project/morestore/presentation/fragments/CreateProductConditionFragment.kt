...
@AndroidEntryPoint
class CreateProductConditionFragment: MvpAppCompatFragment(R.layout.fragment_create_product_condition), CreateProductMvpView {
    ...
    private fun setCheckActive(image: ImageView){
        binding.newWithTagsCheckImageView.imageTintList = null
        binding.newWithoutTagsCheckImageView.imageTintList = null
        binding.excellentCheckImageView.imageTintList = null
        binding.goodCheckImageView.imageTintList = null
