...
interface OrdersApi {
    ...
    @POST("cdek/price")
    suspend fun getCdekPriceError(@Body info: CdekCalculatePriceInfo): Response<CdekErrorInfo>
    ...
    @POST("yandexgo/price")
    suspend fun getYandexGoPriceGetError(@Body info: YandexPriceCalculateInfo): Response<YandexGoErrorEntity>
